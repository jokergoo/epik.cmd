...
dir.create(qq("@{PROJECT_DIR}/image/@{subgroup_str}"), showWarnings = FALES)

pdf(qq("@{PROJECT_DIR}/image/@{subgroup_str}/cr_scatterplot_@{chr}_fdr_@{fdr}_methdiff_@{methdiff}_@{subgroup_str}.pdf"))
