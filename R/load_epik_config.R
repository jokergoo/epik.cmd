...
#
load_epik_config = function(config_file, export_env = parent.frame(), validate = TRUE, use_std_dir = FALSE) {
	...
	optional_config = c(
		"CHROMATIN_STATES_COLOR",
		"CHROMATIN_STATES_ORDER"
	)
